<template>
    <div id='catch-me-if-you-can'>
        ...
        <div role="main" id="content">
            ...
            <img id= "daredevil-img" src="../assets/daredevil-cup.jpg" alt="Image: A promotional poster for the Daredevil Cup in the videogame Fortnite, an ingame recreation of the Daredevil character looks menacingly straigt into the camera. The poster contains the text: 'Play for a chance to earn the daredevil outfit, october 14.'.">
        </div>
    </div>
</template>
